    ...
    Private Sub btnVerificar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnVerificar.Click
        ...
        If band1 And band2 And band3 And band4 And band5 And band6 Then
            ...
            ElseIf frmConsCP.txtDNI.Text <> "" Then
                Me.Close()
                frmVenta.Show()
            ElseIf frmPreCompra.txtDNI.Text <> "" Then
                frmPreCompra.txtmodelo.Enabled = True
                frmPreCompra.txtaño.Enabled = True
                frmPreCompra.txtmarca.Enabled = True
                frmPreCompra.txtmatricula.Enabled = True
                frmPreCompra.txtnbasti.Enabled = True
                frmPreCompra.txtcolor.Enabled = True
                frmPreCompra.txtkmu.Enabled = True
                frmPreCompra.txtprecio.Enabled = True
                frmPreCompra.btnpresu.Enabled = True
