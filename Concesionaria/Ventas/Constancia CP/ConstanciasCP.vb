Public Class frmConsCP
    ...
    Private Sub btnVPres_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnVPres.Click
        If txtPres.Text <> "" Then
            ...
            If rs1(0) = 0 Then
                sql = "Select count(*) " & _
                      "From Autos_presupuestos, Presupuestos P " & _
                      "Where Presupuesto=" & txtPres.Text & " " & _
                      "And P.NPres=Presupuesto " & _
                      "And P.IdCliente=(Select IdCliente " & _
                                       "From Clientes " & _
                                       "Where DNI=" & txtDNI.Text & ")"
                consulta(1)

                sql = "Select count(*) " & _
                      "From AutosU_presupuestos, Presupuestos P " & _
                      "Where Presupuesto=" & txtPres.Text & " " & _
                      "And P.NPres=Presupuesto " & _
                      "And P.IdCliente=(Select IdCliente " & _
                                       "From Clientes " & _
                ...
                If rs1.Read = True And rs2.Read = True Then
                    If rs1(0) = 1 Or rs2(0) = 1 Then
                        ...
                        btnVCR.Enabled = True
                    Else
                        MsgBox("Presupuesto no encontrado o no pertenece a este cliente")
                    End If
                End If
            Else
                MsgBox("Ya hay una constancia de compraventa para este presupuesto")
            End If
        Else
    ...
    Private Sub btnChe_Click1(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnChe.Click
        Me.Hide()
        frmChe.Show()
    End Sub
End Class